        ...
        <div className="grid md:grid-cols-3 gap-10 items-start">
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-zinc-300 leading-relaxed">
              Formados en agosto de 2010 en Olavarría, Buenos Aires, Grotesque
              Impalement se ha consolidado como uno de los referentes del Death
              Metal extremo de la región.
            </p>
            <p className="text-zinc-400 text-sm leading-relaxed">
              Con múltiples lanzamientos independientes, giras nacionales y la
              autogestión del clásico festival *Grotesque Fest*, la banda
              continúa expandiendo su sonido crudo, veloz e implacable.
            </p>
          </div>
          ...
          <div className="bg-zinc-900/90 border border-cyan-500/40 p-6 rounded-lg text-center flex flex-col items-center justify-center space-y-4 shadow-xl">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400 mt-1">
                Fotos HD, bio en PDF, logos vectoriales y rider técnico.
              </p>
            </div>
            <a
